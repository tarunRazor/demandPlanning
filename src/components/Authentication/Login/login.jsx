...
export default function Login() {
  ...
  return (
    <>
      <div className="flex min-h-full h-full flex-1">
        <div className="flex flex-1 flex-col w-6/12 justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              <img className="h-10 w-auto" src={mainlogo} alt="razor" />
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        placeholder="Email"
                        className="block placeholder:text-border-subtle w-full px-3 py-1.5 rounded-md border-0  font-medium text-subtitle relative bg-white shadow-sm ring-1 ring-border-subtle"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        className="block w-full px-3 py-1.5 rounded-md border-0  font-medium text-subtitle relative bg-white placeholder:text-border-subtle shadow-sm ring-1 ring-border-subtle"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    {error && (
                      <div>
                        <label
                          htmlFor="password"
                          className="block  mb-4 text-sm font-medium leading-6 text-warning"
                        >
                          {error}
                        </label>
                      </div>
                    ...
                    <div>
                      <button
                       ...
                       focus-visible:outline-primary items-center
                       disabled:opacity-70
                       "
                      >
                        {isLoading ? (
        ...
        <div className="relative hidden  flex-auto w-6/12 lg:block">
          <img
