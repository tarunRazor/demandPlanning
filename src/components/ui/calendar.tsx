    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-[#0035E9] hover:text-white',
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-[#0035E9] text-white focus:g-[#0035E9] focus:text-white dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900',
